...
message = f"He is going {rate} mph."
print(message)
# Two number values will be added
print()
groceries_item1 = 4.99
groceries_item2 = 7.34
total_cost = groceries_item1 + groceries_item2
groceries = f"The total groceries is {total_cost}"
print(groceries)
print()
